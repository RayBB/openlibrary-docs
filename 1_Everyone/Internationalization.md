...
If the i18n error or warning is a false positive, you may append `$# detect-missing-i18n-skip-line` to the end of your line ([example](https://github.com/internetarchive/openlibrary/pull/9428/files#diff-bca2a6fdc75087bace987c1ffb52482a8aa9777a653f9f5b18971218cf8638eaR35)). You may also insert a line above the detected error that only contains `$# detect-missing-i18n-skip-line` ([example](https://github.com/internetarchive/openlibrary/pull/9428/files#diff-bcf3ac61effa00d5a5e5e195cf8be38f6e11d3949e56d4474dd236c89bb01ae4R255)).
