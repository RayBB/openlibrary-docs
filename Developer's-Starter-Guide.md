...
1. A top black bar [`topNotice`](https://github.com/internetarchive/openlibrary/blob/master/openlibrary/templates/site/alert.html) with an Internet Archive logo:<br><img width="500" alt="Screenshot 2024-09-04 at 6 26 30 AM" src="https://github.com/user-attachments/assets/395c2406-b297-4b9d-bb02-6aee85cc6fb2">
...
Check the [official web.py templator documentation](https://webpy.org/docs/0.3/templetor) if you'd like a deep dive into all the capabilities of Open Library's python-powered templating system.
